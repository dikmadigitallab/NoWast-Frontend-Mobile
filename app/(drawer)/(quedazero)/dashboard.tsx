    ...
    <View style={styles.container}>
      ...
      <View style={styles.contentWrapper}>
        <View style={styles.card}>
          ...
          <FlatList ref={flatListRef} data={screens} renderItem={({ item }) => item.component} keyExtractor={item => item.id} horizontal pagingEnabled showsHorizontalScrollIndicator={false} onMomentumScrollEnd={(e) => {
