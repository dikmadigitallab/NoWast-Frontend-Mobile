      ...
      <View style={styles.contentWrapper}>
        <View style={styles.card}>
          ...
          <View style={styles.sectionHeaderWrapper}>
            <TouchableOpacity style={[styles.sectionHeader, { borderRightColor: '#fff', borderRightWidth: 1 }]} onPress={() => setSessao(0)}>
              <View />
              <Text style={styles.sectionTitle}>Atividades</Text>
              <View style={[styles.activeBar, { opacity: sessao === 0 ? 1 : 0 }]} />
            </TouchableOpacity>
            <TouchableOpacity style={styles.sectionHeader} onPress={() => setSessao(1)}>
              <View />
              <Text style={styles.sectionTitle}>Localizações</Text>
              <View style={[styles.activeBar, { opacity: sessao === 1 ? 1 : 0 }]} />
            </TouchableOpacity>
          </View>
          ...
          <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 330 }}>
            <View style={styles.contentCard}>
              {sessao === 0 ? (
                ...
                <>
                  <Text style={{ fontSize: 22, fontWeight: "bold", marginBottom: 20, color: "#43575F" }}>
                    Localizações
                  </Text>
                  <View style={{ gap: 15 }}>
                        ...
                        {loc.volume.map((vol, volIndex) => (
                          <View key={volIndex} style={{ marginBottom: 8 }}>
                            <View style={{ flexDirection: "row", alignItems: "center" }}>
                              <Feather name={vol.title === "Maior Volume" ? "arrow-up-right" : "arrow-down-left"} size={24} color={vol.title === "Maior Volume" ? "#00A614" : "#FFA44D"} />
                              <Text style={{ fontSize: 16, color: vol.title === "Maior Volume" ? "#00A614" : "#FFA44D", fontWeight: 500 }}>
                                {vol.title}
                              </Text>
                            </View>
...
const styles = StyleSheet.create({
  title: { fontSize: 30, color: "#fff", fontWeight: "500", marginLeft: 20 },
  sectionHeaderWrapper: { width: "100%", flexDirection: "row", backgroundColor: "#F5FBF6", justifyContent: "space-between" },
  sectionHeader: { width: "50%", justifyContent: "space-between", alignItems: "center", height: 50 },
  sectionTitle: { fontSize: 20, fontWeight: "bold", color: "#000" },
  activeBar: { height: 5, width: "60%", backgroundColor: "#28A745", marginTop: 5, borderRadius: 2 },
  contentCard: { padding: 20, gap: 40, },
  container: { flex: 1, alignItems: "center", backgroundColor: "#F7F9FB" },
  headerBackground: { width: "100%", height: 200, backgroundColor: "#186B53" },
  contentWrapper: { marginTop: -160, width: "100%", gap: 10 },
  card: { backgroundColor: "#fff", borderRadius: 20, alignSelf: "center", width: "95%", overflow: "hidden" },
  pageTitle: { fontSize: 24, fontWeight: "bold", color: "#43575F", marginBottom: 20 },
  pieTitle: { fontSize: 20, fontWeight: "600", color: "#43575F", marginBottom: 10 },
  chartRow: { flexDirection: "row", alignItems: "center", width: "100%" },
  chartColumn: { flexDirection: "column", alignItems: "center", width: "100%", gap: 10, marginBottom: 20 },
  pieWrapper: { width: "50%", justifyContent: "center", alignItems: "center" },
  centerLabel: { justifyContent: "center", alignItems: "center" },
  percentageText: { fontSize: 22, color: "#000", fontWeight: "bold" },
  centerLabelText: { fontSize: 14, color: "#000" },
  pieLegend: { width: "50%", justifyContent: "center", alignItems: "center" },
  legendRow: { flexDirection: "row", alignItems: "center", gap: 10 },
  legendDot: { width: 10, height: 10, borderRadius: 100 },
  legendText: { fontSize: 16, color: "#43575F" },
  legendValue: { fontSize: 20, color: "#43575F", marginLeft: 20 },
  mainLocContainer:{borderWidth: 1, borderColor: "#E8F5E9", padding: 15, borderRadius: 10},
  containerLoc: {marginLeft: 10, flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 8}
